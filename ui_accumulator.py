...
"""
to run this boilerplate use this command: python3 ui_accumulator.py

move the app and mainloop at the bottom of the file to your main.py if you would like to run it from main.
